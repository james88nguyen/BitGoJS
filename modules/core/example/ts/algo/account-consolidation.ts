 ...
 * receive addresses.
 *
 * USAGE: This is the simple example of account consolidations.
 */
...
async function main() {
  ...
  // you can also specify which receive address by passing addresses
  // generated by receive address here:
